APPNAME="TalkingData Cocos2dx Sample"
...
COCOS2DXTALKINGDATA_ROOT="$COCOS2DX_ROOT/../game-analytics-cocos2dx"
APP_ROOT="$DIR/.."
...
echo "COCOS2DXTALKINGDATA_ROOT = $COCOS2DXTALKINGDATA_ROOT"
